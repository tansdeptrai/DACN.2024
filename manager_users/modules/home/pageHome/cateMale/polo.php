<?php 
$listProduct = getRaw("SELECT id, name, image, cate_id FROM products WHERE cate_id = 3");
$quanList = getRows("SELECT id, name, image, cate_id FROM products WHERE cate_id = 3");
//id người đăng nhập
$id_user = '';
                    ...
                    <div class="inforProduct2">
                        <div class="colorProduct d-flex mt-2 mb-1">
                            <?php 
                                ...
                                ?>
                            <button class="btnColor" data-idvp="<?php echo $vp['id']; // id variant Product?>" data-idsize="<?php echo $vp['size_id'];?>" data-id="<?php echo $color['id'];?>" data-idpro="<?php echo $product['id'];?>" style="background-color: <?php echo $color['color_code']; ?>;">
                            </button>
                            <?php 
                                        endforeach;
                                    endif;
