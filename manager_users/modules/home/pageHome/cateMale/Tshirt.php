<?php 
$listProduct = getRaw("SELECT id, name, image, cate_id FROM products WHERE cate_id = 1");
$quanList = getRows("SELECT id, name, image, cate_id FROM products WHERE cate_id = 1");
//id người đăng nhập
$id_user = '';
                ...
                <div class="product-item2">
                    ...
                    <div class="inforProduct2">
                        <div class="colorProduct d-flex mt-2 mb-1">
                            ...
                            ?>
                            <button class="btnColor" data-idpro="<?php echo $product['id'];?>" id="img" data-idvp="<?php echo $vp['id']; // id variant Product?>" data-id="<?php echo $color['id'];?>" data-idsize ="<?php echo $vp['size_id'];?>" style="background-color: <?php echo $color['color_code']; ?>;">
                            </button>
                            <?php 
                                        endforeach;
                                    endif;
