...
// list áo phông
$listProductsTshirt = getRaw("SELECT id, name, image, cate_product_id FROM products WHERE cate_product_id = 11 AND cate_id =1 ORDER BY RAND() LIMIT 3");
// list áo polo
$listProductPolo = getRaw("SELECT id, name, image, cate_product_id FROM products WHERE cate_product_id = 11 AND cate_id = 3 ORDER BY RAND() LIMIT 3");
$listProductSuggest = getRaw("SELECT id, name, image, cate_product_id FROM products WHERE cate_product_id = 11  ORDER BY RAND() LIMIT 8");
...
<div class="mt-4 d-flex justify-content-between">
    ...
    <a href="#?module=home/pageHome/cateMale&action=Tshirt"
...
<div class="row">
    ...
    <div class="col-4">
        <img class="pt-3" style="width: 100%;" height="auto"
            src="https://media.canifa.com/Simiconnector/1.AoPhong_slide_desktop-02Oct-b.webp" alt="">
    </div>
    <div class="col-8">
        <div class="product-container mt-3 mb-2">
            ...
            <div class="product-item">
                ...
                <input type="hidden" name="" value="<?php echo $p['id'];?>"> <!-- id product -->
                            ...
                            foreach ($variantPro as $vp):
                                if ($idProduct == $vp['product_id']) :
                                    ...
                                    if ($idColor):
                                        ...
                                        foreach($color as $c):
                        ?>
                        <button class="btnColor" style="background-color: <?php echo $c['color_code']?>;" data-idpro="<?php echo $p['id'];?>"
                            data-idcolor="<?php echo $vp['color_id'];?>" data-idsize="<?php echo $vp['size_id'];?>" data-idvp="<?php echo $vp['id'];?>"></button>
                        <?php
                                        endforeach;
                                    endif;
                                endif;
...
<div class="mt-4 d-flex justify-content-between">
    ...
    <!-- tên danh mục select -->
    <a href="#?module=home/pageHome/cateMale&action=feltPants"
        style="font-weight: 600; text-decoration: none; font-size:15px; color:	#FF0000; padding-top:15px;" class="more">
        Xem thêm </a>
</div>
<!-- End Title -->
<div class="row">
    <div class="col-4">
        <img class="pt-3" style="width: 100%;" height="auto"
            src="https://media.canifa.com/Simiconnector/2.QuanShort_slide_desktop-02Oct.webp" alt="">
    </div>
    <div class="col-8">
        <div class="product-container mt-3 mb-2">
            <!--  -->
...
<div class="mt-4 d-flex justify-content-between">
    ...
    <!-- tên danh mục select -->
    <a href="#?module=home/pageHome/cateMale&action=polo"
        style="font-weight: 600; text-decoration: none; font-size:15px; color:	#FF0000; padding-top:15px;" class="more">
        Xem thêm </a>
</div>
<!-- End Title -->
<div class="row">
    <div class="col-4">
        <img class="pt-3" style="width: 100%;" height="auto"
            src="https://media.canifa.com/Simiconnector/3.AoPolo_slide_desktop-02Oct.webp" alt="">
    </div>
    <div class="col-8">
        <div class="product-container mt-3 mb-2">
            <!--  -->
...
<!-- Title -->
<div class="mt-4 d-flex justify-content-between">
    <span style="font-weight: 600; font-size:25px; letter-spacing: 1px;">Quần dài & Quần Jean</span>
    <!-- tên danh mục select -->
    <a href="#?module=home/pageHome/cateMale&action=pantsMale"
        style="font-weight: 600; text-decoration: none; font-size:15px; color:	#FF0000; padding-top:15px;" class="more">
        Xem thêm </a>
</div>
<!-- End Title -->
<div class="row">
    <div class="col-4">
        <img class="pt-3" style="width: 100%;" height="auto"
            src="https://media.canifa.com/Simiconnector/4.QuanDai_slide_desktop-02Oct-a.webp" alt="">
    </div>
    <div class="col-8">
        <div class="product-container mt-3 mb-2">
            <!--  -->
            ...
            <div class="inforProduct2">
                <div class="colorProduct d-flex mt-2 mb-1">
                    <?php 
                                    ...
                                    ?>
                    <button class="btnColor" data-idpro="<?php echo $product['id'];?>" data-idvp="<?php echo $vp['id']; // id variant Product?>"
...
$(document).ready(function() {
    $(".btnColor").click(function(e) {
        ...
        // console.log('ID variant product: ' + id_product_variant);
