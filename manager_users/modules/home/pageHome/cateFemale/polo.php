<?php 
$listProduct = getRaw("SELECT id, name, image, cate_id FROM products WHERE cate_id = 4");
$quanList = getRows("SELECT id, name, image, cate_id FROM products WHERE cate_id = 4");
//id người đăng nhập
$id_user = '';
                    ...
                    <div class="inforProduct2">
                        <div class="colorProduct d-flex mt-2 mb-1">
                            <?php 
                                ...
                                ?>
                            <button class="btnColor" data-idpro="<?php echo $product['id'];?>" data-idsize="<?php echo $vp['size_id'];?>" data-idvp="<?php echo $vp['id']; // id variant Product?>" data-id="<?php echo $color['id'];?>" style="background-color: <?php echo $color['color_code']; ?>;">
                            </button>
                            <?php 
                                        endforeach;
                                    endif;
